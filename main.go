...
func main() {
	...
	r.GET("/product_category", api.GetProductCategory)
	r.PUT("/product_category", api.RenameCategory)
	r.PUT("/product_size", api.UpdateSizeByProductId)
	r.PUT("/batch_product_category", api.UpdateCategoryByProductId)
	r.PUT("/size_chart", api.UpdateSizeChartBySpu)
	r.POST("/delete_product", api.DeleteProduct)
	r.POST("/delete_empty_product", api.DeleteEmptyProduct)
